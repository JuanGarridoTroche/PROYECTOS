...
class DataHelper #extends Mage_Core_Helper_Abstract
{
    ...
    public function generateDelivery($filenames)
    {
        ...
        $url = \Context::getContext()->link->getBaseLink() . 'modules/mbeshipping/pdf.php?' . $result;*/
        ...
        $url = \Context::getContext()->link->getModuleLink('mbeshipping', 'mbeaction', array('files' => $result));
    ...
    {
        return \Configuration::get(self::XML_PATH_AUTO_CHANGE_ORDER_STATUS, $storeId);
    }
